...
class MHCnet_Up_Sampling_Loss(nn.Module):
    def __init__(self, n_channels, n_classes=1, bilinear=False):
        super(MHCnet_Up_Sampling_Loss, self).__init__()
        self.n_channels = n_channels
        self.n_classes = n_classes
        self.bilinear = bilinear
...
class MHCnet_Multi_Layer_Loss(nn.Module):
    def __init__(self, n_channels, n_classes=1, bilinear=False):
        super(MHCnet_Multi_Layer_Loss, self).__init__()
        self.n_channels = n_channels
        self.n_classes = n_classes
        self.bilinear = bilinear
...
'''
    Different combinations of losses in MHC-Net. 
    The Hierarchical Fusing Loss used in MHC-Net is the combinations of Upsampling Loss and Multi-layer Loss.
'''


class MHCnet_Hierarchical_Fusing_Loss(nn.Module):
    def __init__(self, n_channels, n_classes=1, bilinear=False):
        super(MHCnet_Hierarchical_Fusing_Loss, self).__init__()
        self.n_channels = n_channels
        self.n_classes = n_classes
        self.bilinear = bilinear
