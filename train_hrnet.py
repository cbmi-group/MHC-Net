...
def train_eval_model(opts):
    ...
    for epoch in range(start_epoch, num_epochs):
        ...
        epoch_acc, epoch_iou, epoch_f1, epoch_distance = eval_one_epoch(epoch, dataloaders_dict['eval'], hrnet_model,
                                                                        device, train_dir, log_file)
...
if __name__ == '__main__':
    ...
    log_dir = "./train_log/" + str(opts["dataset_type"]) + "_train_HRNet_" + str(
